...
$app->post('/2du/:surveyId/', function ($lastsurvey_id) use ($app) {
    ...
    $industry_other = isset($allPostVars['industry_other']) ? mysql_real_escape_string($allPostVars['industry_other']) : null;
    ...
    $org_description = isset($allPostVars['org_description']) ? mysql_real_escape_string($allPostVars['org_description']) : null;
    $org_greatest_impact = isset($allPostVars['org_greatest_impact']) ? mysql_real_escape_string($allPostVars['org_greatest_impact']) : null;
    $org_greatest_impact_detail = isset($allPostVars['org_greatest_impact_detail']) ? mysql_real_escape_string($allPostVars['org_greatest_impact_detail']) : null;
    $org_name = isset($allPostVars['org_name']) ? mysql_real_escape_string($allPostVars['org_name']) : null;
    $org_profile_category = isset($allPostVars['org_profile_category']) ? mysql_real_escape_string($allPostVars['org_profile_category']) : null;
    $org_profile_src = isset($allPostVars['org_profile_src']) ? mysql_real_escape_string($allPostVars['org_profile_src']) : null;
    ...
    $org_type_other = isset($allPostVars['org_type_other']) ? mysql_real_escape_string($allPostVars['org_type_other']) : null;
    ...
    /* org_contacts */
    $survey_contact_first = isset($allPostVars["survey_contact_first"]) ? mysql_real_escape_string($allPostVars["survey_contact_first"]) : null;
    $survey_contact_last =  isset($allPostVars["survey_contact_last"]) ? mysql_real_escape_string($allPostVars["survey_contact_last"]) : null;
    $survey_contact_title = isset($allPostVars["survey_contact_title"]) ? mysql_real_escape_string($allPostVars["survey_contact_title"]) : null;
    $survey_contact_email = isset($allPostVars["survey_contact_email"]) ? mysql_real_escape_string($allPostVars["survey_contact_email"]) : null;
    $survey_contact_phone = isset($allPostVars["survey_contact_phone"]) ? mysql_real_escape_string($allPostVars["survey_contact_phone"]) : null;
    ...
    $use_advocacy_desc = isset($allPostVars["use_advocacy_desc"]) ? mysql_real_escape_string($allPostVars["use_advocacy_desc"]) : null;
    $use_org_opt_desc = isset($allPostVars["use_org_opt_desc"]) ? mysql_real_escape_string($allPostVars["use_org_opt_desc"]) : null;
    $use_other_desc = isset($allPostVars["use_other_desc"]) ? mysql_real_escape_string($allPostVars["use_other_desc"]) : null;
    $use_prod_srvc_desc = isset($allPostVars["use_prod_srvc_desc"]) ? mysql_real_escape_string($allPostVars["use_prod_srvc_desc"]) : null;
    $use_research_desc = isset($allPostVars["use_research_desc"]) ? mysql_real_escape_string($allPostVars["use_research_desc"]) : null;
    ...
    $other = isset($allPostVars['data_use_type_other']) ? mysql_real_escape_string($allPostVars['data_use_type_other']) : null;
