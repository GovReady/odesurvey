...
$app->post('/2du/:surveyId/', function ($lastsurvey_id) use ($app) {
    ...
    $industry_other = isset($allPostVars['industry_other']) ? mysqli::real_escape_string($allPostVars['industry_other']) : null;
    ...
    $org_description = isset($allPostVars['org_description']) ? mysqli::real_escape_string($allPostVars['org_description']) : null;
    $org_greatest_impact = isset($allPostVars['org_greatest_impact']) ? mysqli::real_escape_string($allPostVars['org_greatest_impact']) : null;
    $org_greatest_impact_detail = isset($allPostVars['org_greatest_impact_detail']) ? mysqli::real_escape_string($allPostVars['org_greatest_impact_detail']) : null;
    $org_name = isset($allPostVars['org_name']) ? mysqli::real_escape_string($allPostVars['org_name']) : null;
    $org_profile_category = isset($allPostVars['org_profile_category']) ? mysqli::real_escape_string($allPostVars['org_profile_category']) : null;
    $org_profile_src = isset($allPostVars['org_profile_src']) ? mysqli::real_escape_string($allPostVars['org_profile_src']) : null;
    ...
    $org_type_other = isset($allPostVars['org_type_other']) ? mysqli::real_escape_string($allPostVars['org_type_other']) : null;
    ...
    /* org_contacts */
    $survey_contact_first = isset($allPostVars["survey_contact_first"]) ? mysqli::real_escape_string($allPostVars["survey_contact_first"]) : null;
    $survey_contact_last =  isset($allPostVars["survey_contact_last"]) ? mysqli::real_escape_string($allPostVars["survey_contact_last"]) : null;
    $survey_contact_title = isset($allPostVars["survey_contact_title"]) ? mysqli::real_escape_string($allPostVars["survey_contact_title"]) : null;
    $survey_contact_email = isset($allPostVars["survey_contact_email"]) ? mysqli::real_escape_string($allPostVars["survey_contact_email"]) : null;
    $survey_contact_phone = isset($allPostVars["survey_contact_phone"]) ? mysqli::real_escape_string($allPostVars["survey_contact_phone"]) : null;
    ...
    $use_advocacy_desc = isset($allPostVars["use_advocacy_desc"]) ? mysqli::real_escape_string($allPostVars["use_advocacy_desc"]) : null;
    $use_org_opt_desc = isset($allPostVars["use_org_opt_desc"]) ? mysqli::real_escape_string($allPostVars["use_org_opt_desc"]) : null;
    $use_other_desc = isset($allPostVars["use_other_desc"]) ? mysqli::real_escape_string($allPostVars["use_other_desc"]) : null;
    $use_prod_srvc_desc = isset($allPostVars["use_prod_srvc_desc"]) ? mysqli::real_escape_string($allPostVars["use_prod_srvc_desc"]) : null;
    $use_research_desc = isset($allPostVars["use_research_desc"]) ? mysqli::real_escape_string($allPostVars["use_research_desc"]) : null;
    ...
    $other = isset($allPostVars['data_use_type_other']) ? mysqli::real_escape_string($allPostVars['data_use_type_other']) : null;
